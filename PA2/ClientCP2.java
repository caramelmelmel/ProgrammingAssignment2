...
public class ClientCP2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // FOR CP2 PROTOCOL, ENCRYPT SESSION KEY AND SEND IT
            //generate AES session key
            KeyGenerator keyGen = KeyGenerator.getInstance("AES");
            SecretKey seshKey = keyGen.generateKey();

            //Encrypt Session Key using RSA cipher
            byte[] encryptedSeshKey = useCipher(seshKey.getEncoded(), true, "RSA", ServerPubKey);
            sendToServer(encryptedSeshKey, toServer);
            // toServer.flush();
            ...
            // Init seshKeyCipher
            seshKeyCipher = Cipher.getInstance("AES");
            seshKeyCipher.init(Cipher.ENCRYPT_MODE, seshKey);
            ...
            while(true) {
                ...
                toServer.writeInt(0);
                byte [] filenameCP1 = seshKeyCipher.doFinal(filename.getBytes());
                ...
                for (boolean fileEnded = false; !fileEnded;) {
                    ...
                    toServer.writeInt(1);
                    byte [] fromFileBufferCP1 = seshKeyCipher.doFinal(fromFileBuffer);
